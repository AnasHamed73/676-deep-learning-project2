...
# split. 80% of the data goes for training, 10% for validation and 10% for test
...
data_splits_path = "/home/kikuchio/Documents/courses/deep-learning/project2/splits"
